 ...
 * detected, update both this file and camera_common.c.
 *
 *   Y16_1X16    (0x202e) — official mainline code added in 5.4 (next free
 *                          was 0x202e in this BSP's header comment).
 *   Y16BE_1X16  (0x20BE) — EG-private; 0xBE mnemonic for Big-Endian; placed
 *                          well above the sequential Y block (< 0x202f).
 */
